...
// Fork customisation: default this deployment to our own homeserver rather than matrix.org.
// Kept at the definition site so both consumers pick it up: the pre-selected provider in
// AccountProviderDataSource and the autocomplete fallback in ConfirmAccountProviderPresenter.
